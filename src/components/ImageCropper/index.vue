    ...
    <div class="vicp-wrap">
      ...
      <div v-show="step == 1" class="vicp-step1">
        <div class="vicp-drop-area" @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @click="handleClick" @drop="handleChange">
          ...
          <span v-show="loading !== 1" class="vicp-hint">点击，或拖动图片至此处</span>
          <span v-show="!isSupported" class="vicp-no-supported-hint">浏览器不支持该功能，请使用IE10以上或其他现在浏览器！</span>
      ...
      <div v-if="step == 2" class="vicp-step2">
        ...
        <div class="vicp-operate">
          ...
          <a class="vicp-operate-btn" @click="prepareUpload" @mousedown="ripple">确定</a>
        </div>
      </div>

      <div v-if="step == 3" class="vicp-step3">
        <div class="vicp-upload">
          <span v-show="loading === 1" class="vicp-loading">正在上传……</span>
...
export default {
  ...
  methods: {
    ...
    prepareUpload() {
      ...
      // console.log(createImgUrl, field, ki)
    ...
    upload() {
      let that = this,
        ...
        fmData = new FormData()
      console.log(field, data2blob(createImgUrl, mime),field + '.' + imgFormat)
